...
def test_estimate_quarters_worked_prd_reference_year() -> None:
    ...
    assert estimate_quarters_worked(1990, reference_year=2026) == (2026 - 1990) * 4
    assert estimate_quarters_worked(1990, reference_year=2026) == 144


def test_estimate_quarters_worked_cap_at_172() -> None:
    assert estimate_quarters_worked(1980, reference_year=2026) == 172
    assert estimate_quarters_worked(1983, reference_year=2026) == 172  # 43 * 4 = 172


def test_estimate_quarters_worked_future_start_returns_zero() -> None:
    assert estimate_quarters_worked(2030, reference_year=2026) == 0
