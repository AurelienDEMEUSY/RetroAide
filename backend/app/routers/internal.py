...
from app.schemas import EnrichmentSection, UserProfile
...
@router.post("/context", response_model=EnrichmentSection)
def post_retirement_context_preview(
    ...
    return EnrichmentSection.model_validate(er.to_dict())
